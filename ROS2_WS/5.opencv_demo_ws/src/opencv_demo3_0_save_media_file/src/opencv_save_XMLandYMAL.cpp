...
int main(int argc, char** argv)
{
	...
	string fileName = "./src/opencv_demo3_0_save_media_file/save_files/datas.xml";  //文件的名称
	// string fileName = "./src/opencv_demo3_0_save_media_file/save_files/datas.yaml";  //文件的名称
	//以写入的模式打开文件
